...
def detect_segments(audio_dir: Path, top_db: float = 30.0,
    ...
    by duration. Returns a DataFrame with columns: audio_file, segment_id,
    start, end, duration.
...
if __name__ == "__main__":
    ...
    if not models_to_run:
        print("ERREUR: No trained models found. Check models/ directory.")
        sys.exit(1)
